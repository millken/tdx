...
func (c *Client) GetCompanyCategory(code string) ([]CompanyCategoryItem, error) {
...
func (c *Client) GetCompanyContent(code string, filename string, start uint32, length uint32) (string, error) {
	if err := c.ensureConn(); err != nil {
		return "", err
	}
